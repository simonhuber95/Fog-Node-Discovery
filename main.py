...
def main():
    ...
    # Create map of biggest cities in Germany
...
# ------------------------------------------------------  
    ...
    if unlimited_bandwidth and not isinstance(max_clients, int):
        warnings.warn("Unlimited bandwidth and no max_clients can lead to a very high amount of clients in the simulation")
    ...
    if unlimited_bandwidth:
        max_clients = min(max_clients, len(client_plans)) if isinstance(max_clients, int) else len(client_plans)
    # With limited bandwidth we take the minimum of client ratio and max numbers of clients if defined, 
    # else the client ratio
    else:
        max_clients=min(total_slots * client_ratio, max_clients) if isinstance(max_clients, int) else total_slots * client_ratio
